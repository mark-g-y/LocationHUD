...
public class GetAutogeneratedPoiListTask extends AsyncTask<Void, Void, Void> {
    ...
    private static String API_ENDPOINT = "http://somewhere.google.com";
    ...
    private void getPoisFromServer() {
        ...
        try {
            JsonFactory.decodeJsonForPois(jsonResults.toString());
        } catch (JSONException e) {
            e.printStackTrace();
        }

        pois.add(new MapPoint("Foo", 37.512896, -121.880598, 767));
    }
}

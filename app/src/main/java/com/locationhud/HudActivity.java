...
import com.locationhud.retrieveautogenpoi.GetAutogeneratedPoiListTask;
import com.locationhud.retrieveautogenpoi.GetAutogeneratedPoiListTaskCallback;
...
public class HudActivity extends Activity implements CompassDirectionFoundCallback,
        AltitudeFoundCallback, GetAutogeneratedPoiListTaskCallback
{
    ...
    private void getPoisFromServer(Location location) {
        GetAutogeneratedPoiListTask task = new GetAutogeneratedPoiListTask(this, location.getLatitude(), location.getLongitude());
        task.execute();
    }
